...
Field index: assets/schemas/fluxinstance-fluxcd-v1.txt
...
Field index: assets/schemas/resourceset-fluxcd-v1.txt
...
Field index: assets/schemas/resourcesetinputprovider-fluxcd-v1.txt
