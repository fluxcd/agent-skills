...
Field index: assets/schemas/gitrepository-source-v1.txt
...
Field index: assets/schemas/ocirepository-source-v1.txt
...
Field index: assets/schemas/bucket-source-v1.txt
...
Field index: assets/schemas/helmrepository-source-v1.txt
...
Field index: assets/schemas/helmchart-source-v1.txt
...
Field index: assets/schemas/externalartifact-source-v1.txt
...
Field index: assets/schemas/artifactgenerator-source-v1beta1.txt
...
Field index: assets/schemas/kustomization-kustomize-v1.txt
...
Field index: assets/schemas/helmrelease-helm-v2.txt
...
Field index: assets/schemas/provider-notification-v1beta3.txt
...
Field index: assets/schemas/alert-notification-v1beta3.txt
...
Field index: assets/schemas/receiver-notification-v1.txt
...
Field index: assets/schemas/imagerepository-image-v1.txt
...
Field index: assets/schemas/imagepolicy-image-v1.txt
...
Field index: assets/schemas/imageupdateautomation-image-v1.txt
